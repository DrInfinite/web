...
import { useActiveSectionContext } from '../../context/hooks';
...
export function Intro(props: IntroProps) {
    ...
    return (
        ...
        >
            ...
            >
                <span className="font-bold">Hello, I&apos;m Naparajith.</span>{' '}
                I&apos;m a{' '}
            ...
            >
                ...
                >
                    Resume{' '}
                    <HiDocument className="opacity-60 transition group-hover:translate-y-1" />
                </a>
